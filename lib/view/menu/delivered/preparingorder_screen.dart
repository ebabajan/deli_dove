          ...
          children: [
            ListView(
              ...
              Row(
                ...
                children: [
                  Text("Preparing Order",style: TextStyle(color: appcolors,fontWeight: FontWeight.bold,fontSize: 20),),
                ],
              ),
                SizedBox(height: 20,),
                Image.asset("assets/images/prepar.png"),
                SizedBox(height: 20,),
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Step 2",style: TextStyle(color: Colors.grey,fontSize: 16,fontWeight: FontWeight.w500),),
                        SizedBox(height: 10,),
                        Container(
                          height: 5,
                          width: 100,
