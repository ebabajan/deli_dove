            ...
            ListView(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text("Delivered",style: TextStyle(color: appcolors,fontWeight: FontWeight.bold,fontSize: 20),),
                  ],
                ),
                SizedBox(height: 20,),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Step 3",style: TextStyle(color: appcolors,fontSize: 16,fontWeight: FontWeight.w500),),
                        SizedBox(height: 10,),
                        Container(
                          height: 5,
                          width: 100,
                  ...
                  onPressed: () {
                    AwesomeNotifications().createNotification(
                        content: NotificationContent(
                            ...
                            title: 'Delivered',
                            body: 'Product is delivered Successfully'
                        )
                    );
                    Get.to(CheckOutScreen());
                  },
                  child:  Text("Confirmation",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),),
                ),
              ],
            ),
          ],
